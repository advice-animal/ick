...
be written in many different languages, using any tooling they need.  Ick's
philosophy is to meet you where you are: if you have code analysis and
modification tools at hand, you can use them to write a rule for use with ick.
...
but the rule can still be easily run on its own.  This simplifies your
development and keeps ick simpler.
